...
common_srcs ?= $(common_srcdir)/utils.d $(common_srcdir)/numerics.d $(common_srcdir)/fieldlist.d $(common_srcdir)/getopt_inorder.d $(common_srcdir)/unittest_utils.d $(common_srcdir)/tsvutils_version.d
app_src ?= $(CURDIR)/src/$(tsv_utils_pkg_name)/$(app).d
