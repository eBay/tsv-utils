...
* [Performance studies](docs/Performance.md), including the [2018 Comparative Benchmark Update](docs/ComparativeBenchmarks2018.md)
...
Speed matters when processing large files, these tools are the fastest the author has found. See the [2018 Comparative Benchmark Update](docs/ComparativeBenchmarks2018.md) for comparisons with similar tools.
