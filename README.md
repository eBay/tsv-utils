...
* [Releases](https://github.com/eBay/tsv-utils/releases) - Prebuilt binaries and release notes. Recent updates:
  * Named field support! See the [version 2.0.1 release notes](https://github.com/eBay/tsv-utils/releases/tag/v2.0.0).
  * `csv2tsv` performance and functionality enhancements. See the [version 2.1.0 release notes](https://github.com/eBay/tsv-utils/releases/tag/v2.1.0).
