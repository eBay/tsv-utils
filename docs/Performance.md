...
Performance is a key motivation for writing tools like these in D rather an interpreted language like Python or Perl. It is also a consideration in choosing between D and C/C++.
